...
public class poc extends PApplet {
...
public void drawGun(int translateX, int translateY, int index, boolean selectedA, int playerIndex) {
  if(!selectedA) {
...
public void gunFire(int bulletX, int bulletY, int burstAmount, int burstAngle, int bulletSpeed, int bulletSize, boolean selectedA) {
...
//    }
//}
  public void settings() {  size(1500, 725); }
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "poc" };
    if (passedArgs != null) {
